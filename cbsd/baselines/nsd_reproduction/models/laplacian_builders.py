...
import cbsd.baselines.nsd_reproduction.lib.laplace as lap
from cbsd.baselines.nsd_reproduction.models.orthogonal import Orthogonal
...
class NormConnectionLaplacianBuilder(LaplacianBuilder):
    ...
    def forward(self, map_params, edge_weights=None):
        ...
        tril_maps, diag_maps = tril_maps.view(-1), diag_maps.expand(-1, self.d).reshape(
            -1
        )
